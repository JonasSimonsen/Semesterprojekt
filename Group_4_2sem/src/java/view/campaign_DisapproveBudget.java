 ...
 */
@WebServlet(name = "campaign_DisapproveBudget", urlPatterns = {"/campaign_DisapproveBudget"})
public class campaign_DisapproveBudget extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(campaign_DisapproveBudget.class.getName()).log(Level.SEVERE, null, ex);
        }
