 ...
 */
@WebServlet(name = "campaign_DisapprovePOE", urlPatterns = {"/campaign_DisapprovePOE"})
public class campaign_DisapprovePOE extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(campaign_DisapprovePOE.class.getName()).log(Level.SEVERE, null, ex);
        }
